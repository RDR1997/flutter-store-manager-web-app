                      ...
                      (BuildContext context, int index) {
                        return Obx(
                          () => Padding(
                            ...
                            child: productController.productsList.isEmpty
                                ? const Center(
                                    child: Text(
                                    ...
                                    child: homeController.isMobile.value
                                                          ...
                                                          children: [
                                                            ...
                                                            Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                      'Brand: {${productController.productsList[index].brandName}}',
                                                                      style: const TextStyle(
                                                                          fontSize:
                                                                              20,
                                                                          fontWeight:
                                        ...
                                        : ListView.builder(
                                            ...
                                            itemBuilder: (context, index) {
                                              ...
                                              List<RxString> variables =
                                                  <RxString>[];
                                              variables =
                                                  List<RxString>.generate(
                                                      productController
                                                          .productsList.length,
                                                      (_) => '0'.obs);
                                                          ...
                                                          child:
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return productController
                                                                      ...
                                                                      .isEmpty
                                                                  ? const Text(
                                                                      'No Images of this product found',
                                                                      style: TextStyle(
                                                                          fontSize:
                                                                              20,
                                                                          fontWeight:
                                                                  ...
                                                                  : GestureDetector(
                                                                      onTap:
                                                                          () {
                                                                        productController.selectedImageUrl.value = productController
                                                                            .productsList[index]
                                                                            .images[xindex]
                                                                            .imageUrl;
                                                                        showDialog<
